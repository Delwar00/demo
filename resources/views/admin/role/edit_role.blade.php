                      ...
                      <span  class=" col-md-12 well">
                        <span  >
                          ...
                          <a  href="{{ route('role.index') }}" class="back btn btn-info pull-right" style="float:right">
                              <i class="far fa-arrow-alt-circle-left lol" style="color:blue"></i> Back</a>
                        </span>
                      </span>
                    </h3>
                </div>
                    ...
                    <form action="{{ route('role.update',$edit_user_role->id) }}" method="post">
                        ...
                        <div class="row"  >
                            ...
                            <div class="col-md-4 all">
                                <div class="input-group all1">
                                    ...
                                    <input id="name" name="name" value="{{ $edit_user_role->name }}" class="form-control @error('name') is-invalid @enderror"  type="text" >
                                </div>
                                @error('name')
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-4 all">
                                <div class="input-group all1" >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea id="note" name="note"  class="form-control" cols="30" rows="4" required> {{ $edit_user_role->note }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
