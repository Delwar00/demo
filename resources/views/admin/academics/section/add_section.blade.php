                ...
                <div class="card-header" style="text-transform:uppercase;margin-top:18px">
                    <h3>
                      <span  class=" col-md-12 well">
                        <span  >
                            <span  class="all-header" >add section</span>
{{--                          <a  href="{{ route('section.index') }}"  class="btn btn-info pull-right" style="float:right">Back</a>--}}
                        </span>
                      </span>
                    </h3>
                </div>
                        ...
                        <div class="row"  >
                            ...
                            <div class="col-md-6 all">
                                <div class="input-group all1">
                                    ...
                                    <input placeholder="Section Name" id="name" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror"  type="text" >
                                </div>
                                @error('name')
