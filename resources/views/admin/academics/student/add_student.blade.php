                ...
                <div class="card-header" style="text-transform:uppercase;margin-top:18px">
                    <h3>
                      <span  class=" col-md-12 well">
                        <span  >
                            <span  class="all-header">add student</span>
                          <a  href="{{ route('student.index') }}"  class="back btn btn-info pull-right" style="float:right">
                              <i class="lol far fa-arrow-alt-circle-left"></i> Back</a>
                        </span>
                      </span>
                    </h3>
                </div>
                    ...
                    <form action="{{ route('student.store') }}" method="post">
                        ...
                        <div class="row" style="margin-bottom:20px">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea placeholder="Present Address"  id="present_address" name="present_address"  class="form-control"  rows="2">{{ old('present_address') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea placeholder="Permanent Address" id="permanent_address" name="permanent_address"  class="form-control"  rows="2">{{ old('permanent_address') }}</textarea>
                                </div>
                            </div>
                            <br><br><br><br>
                        </div>
