                ...
                <div class="card-header" style="text-transform:uppercase;margin-top:18px">
                    <h3>
                      <span  class=" col-md-12 well">
                        <span  >
                            <span  class="all-header" >add class</span>
                    ...
                    <form action="{{ route('class.store') }}" method="post">
                        ...
                        <div class="row"  >
                            ...
                            <div class="col-md-6 all">
                                <div class="input-group all1">
                                    ...
                                    <input placeholder="Class Name"  name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror"  type="text" >
                                </div>
                                @error('name')
                        ...
                        <div class="row"  >
                            ...
                            <div class="col-md-6 all">
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <input placeholder="Numeric Name" id="numeric_name" value="{{ old('numeric_name') }}" name="numeric_name"  class="form-control @error('numeric_name') is-invalid @enderror"  type="text" >
                                </div>
                                @error('numeric_name')
                                <div class="error">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="input-group all1">
                                    ...
                                    <select id="teacher_id" name="teacher_id"  class="form-control @error('teacher_id') is-invalid @enderror">
                                        ...
                                        @foreach($teacher as $key=>$value)
                                            <option value="{{ $value->id }}"@if(old('teacher_id') == $value->id) {{'selected'}} @endif>{{ $value->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('teacher_id')
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-6 all">
                                <div class="input-group all1" >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea placeholder="Note" id="note" name="note" class="form-control" cols="30" rows="4" >{{ old('note') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
