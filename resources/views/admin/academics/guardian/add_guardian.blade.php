                ...
                <div class="card-header" style="text-transform:uppercase;margin-top:18px">
                    <h3>
                      <span  class=" col-md-12 well">
                        <span  >
                            <span class="all-header" >add guardian</span>
                    ...
                    <form action="{{ route('guardian.store') }}" method="post">
                        ...
                        <div class="row" style="margin-bottom:20px">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <input placeholder="Phone" value="{{ old('phone') }}"  name="phone"  class="form-control @error('phone') is-invalid @enderror"  type="text" >
                                </div>
                                @error('phone')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <input placeholder="Profession" name="profession"  value="{{ old('profession') }}" class="form-control @error('profession') is-invalid @enderror"  type="text" >
                                </div>
                                @error('profession')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea id="Present Address" name="present_address"  class="form-control" rows="2">{{ old('present_address') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea id="Permanent Address" name="permanent_address"  class="form-control" rows="2">{{ old('permanent_address') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom:20px">
                            <div class="col-md-3">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <input placeholder="National Id" value="{{ old('national_id') }}"  name="national_id"  class="form-control"  type="text" >
                                </div>
                            </div>
                            <div class="col-md-3">
