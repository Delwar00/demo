                ...
                <div class="card-header" style="text-transform:uppercase;margin-top:18px">
                    <h3>
                      <span  class=" col-md-12 well">
                        <span  >
                            <span  class="all-header">add manage employee</span>
                    ...
                    <form action="{{ route('employee.store') }}" method="post">
                        ...
                        <div class="row" style="margin-bottom:20px">
                                ...
                                <div class="input-group all1">
                                    ...
                                    <select id="designation_id" name="designation_id"  class="form-control @error('designation_id') is-invalid @enderror">
                                        <option value="">===Select===</option>
                                            ...
                                            <option value="{{ $value->id }}"@if(old('designation_id') == $value->id) {{'selected'}} @endif>{{ $value->name }}</option>
                                            @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <input placeholder="Dob" id="dob" name="dob" value="{{ old('dob') }}"  class="datepicker form-control @error('dob') is-invalid @enderror"  type="text" >
                                </div>
                                @error('dob')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea placeholder="Present Address"   name="present_address"  class="form-control"  rows="2">{{ old('present_address') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group all1">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-plus"></i></span>
                                    <textarea placeholder="Permanent Address"   name="permanent_address"  class="form-control"  rows="2">{{ old('permanent_address') }}</textarea>
                                </div>
                            </div>
                        </div>
